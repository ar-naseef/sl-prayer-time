...
export default function TodayHighlight({ prayerTimes, heading, districtName }: TodayHighlightProps) {
    ...
    <section className="space-y-4">
      <div className="flex flex-col gap-2">
        <p className="text-sm text-muted-foreground">
          Today&apos;s prayer times in {districtName}, Sri Lanka, based on ACJU prayer
          times.
        </p>
